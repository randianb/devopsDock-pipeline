...
[Pipeline] sh
+ curl -s --user '****:****' 'https://cdp-jenkins-paas-xsf.fr.world.socgen/job/DJD/job/CD-Deploy/job/openr-pipeline-int/806/api/json?tree=actions%5Bparameters%5B*%5D%5D'
[Pipeline] echo
Build Info JSON: {"_class":"org.jenkinsci.plugins.workflow.job.WorkflowRun","actions":[{"_class":"hudson.model.ParametersAction","parameters":[{"_class":"hudson.model.BooleanParameterValue","name":"LATEST_IMAGE","value":false},{"_class":"hudson.model.BooleanParameterValue","name":"INFRA","value":false},{"_class":"hudson.model.BooleanParameterValue","name":"DEPLOY_FRONTEND","value":true},{"_class":"hudson.model.BooleanParameterValue","name":"DEPLOY_BACKEND","value":false},{"_class":"hudson.model.StringParameterValue","name":"FRONTEND_VERSION","value":"2.1.1-SNAPSHOT"},{"_class":"hudson.model.StringParameterValue","name":"BACKEND_VERSION","value":""},{"_class":"hudson.model.StringParameterValue","name":"VERSION_TYPE","value":"snapshots"},{"_class":"hudson.model.StringParameterValue","name":"REGION","value":"'[\"paris\"]'"}]},{"_class":"hudson.model.CauseAction"},{"_class":"jenkins.metrics.impl.TimeInQueueAction"},{},{"_class":"org.jenkinsci.plugins.workflow.libs.LibrariesAction"},{},{"_class":"hudson.plugins.git.util.BuildData"},{},{"_class":"org.jenkinsci.plugins.workflow.cps.EnvActionImpl"},{},{"_class":"hudson.plugins.git.util.BuildData"},{"_class":"org.jenkinsci.plugins.workflow.cps.view.InterpolatedSecretsAction"},{},{},{},{},{"_class":"org.jenkinsci.plugins.displayurlapi.actions.RunDisplayAction"},{"_class":"org.jenkinsci.plugins.pipeline.modeldefinition.actions.RestartDeclarativePipelineAction"},{},{"_class":"org.jenkinsci.plugins.workflow.job.views.FlowGraphAction"},{},{},{}]}
[Pipeline] readJSON
[Pipeline] echo
Parameters for New Build: LATEST_IMAGE=false&INFRA=false&DEPLOY_FRONTEND=true&DEPLOY_BACKEND=false&FRONTEND_VERSION=2.1.1-SNAPSHOT&BACKEND_VERSION=&VERSION_TYPE=snapshots&REGION='["paris"]'
[Pipeline] sh
+ curl -s -X POST --user '****:****' 'https://cdp-jenkins-paas-xsf.fr.world.socgen/job/DJD/job/CD-Deploy/job/openr-pipeline-int/buildWithParameters?LATEST_IMAGE=false&INFRA=false&DEPLOY_FRONTEND=true&DEPLOY_BACKEND=false&FRONTEND_VERSION=2.1.1-SNAPSHOT&BACKEND_VERSION=&VERSION_TYPE=snapshots&REGION=[paris]'
[Pipeline] echo
Build Trigger Response: <!DOCTYPE html><html><head resURL="/static/672d5e66" data-rooturl="" data-resurl="/static/672d5e66" data-extensions-available="true" data-unit-test="false" data-imagesurl="/static/672d5e66/images" data-crumb-header="" data-crumb-value="">
...
" data-dropdown-text="Website" data-dropdown-type="ITEM" data-dropdown-href="https://www.jenkins.io/"></template></div></template></div></div></footer></body></html>
[Pipeline] }
[Pipeline] // script
[Pipeline] }
...
/var/jenkins_home/jobs/DJD/jobs/Build-Archived/workspace/JenkinsCron@tmp/jfrog/22/.jfrog deleted
Finished: SUCCESS
